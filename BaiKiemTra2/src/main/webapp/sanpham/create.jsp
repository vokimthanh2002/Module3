...
<form method="post" >
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input name="tenSP" type="text" class="form-control"  placeholder="Nhap ten san pham">
        </div>
        ...
        <div class="form-group col-md-6">
            <label>Gia</label>
            <input name="gia" type="text" class="form-control"  placeholder="Nhap gia san pham">
        </div>
        <div class="form-group col-md-6">
            <label>So luong san pham</label>
            <input name="soluong" type="text" class="form-control" placeholder="Nhap so luong san pham"  >
        </div>
        <div class="form-group col-md-6">
            <label>Mau sac san pham</label>
            <input name="mausac" type="text" class="form-control" placeholder="Nhap mau sac san pham"   >
        </div>
        <div class="form-group col-md-6">
            <label>Mo ta</label>
